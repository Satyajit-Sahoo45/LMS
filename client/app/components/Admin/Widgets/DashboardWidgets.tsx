  ...
  return (
    <div className="mt-[30px] min-h-screen">
          ...
          <div className="w-full dark:bg-[#111C43] rounded-sm shadow">
            <div className="flex items-center p-5 justify-between">
              <div className="">
                ...
                <h5 className="pt-2 font-sans dark:text-[#fff] text-black text-[20px]">
                  {ordersComparePercentage?.currentMonth}
                </h5>
                <h5 className="py-2 font-sans dark:text-[#45CBA0] text-black text-[20px] font-[400]">
                  Sales Obtained
                </h5>
              </div>
              <div>
      ...
      <div className="grid grid-cols-[65%,35%] mt-[-20px]">
        ...
        <div className="p-5">
          <h5 className="dark:text-[#fff] text-black text-[20px] font-[400] font-sans pb-3">
            Recent Transactions
          </h5>
